            ...
            child: Column(
              ...
              children: <Widget>[
                Icon(
                  Icons.person,
                  size: 100,
                  color: Color.fromRGBO(66, 3, 138, 54),
                ),
                TextFormField(
                  key: Key('WeightInput'),
                  ...
                  decoration: InputDecoration(
                    labelText: "Peso (Kg)",
                    labelStyle:
                        TextStyle(color: Color.fromRGBO(137, 69, 2014, 84)),
                  ),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Color.fromRGBO(41, 2, 87, 34), fontSize: 25.0),
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Color.fromRGBO(66, 3, 138, 54), fontSize: 20.0),
                )
              ],
            ),
          ),
